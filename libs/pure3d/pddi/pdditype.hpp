...
// Note: RAD_WIN32 is defined as a generic "desktop" define for the port,
// so on Linux both RAD_WIN32 and RAD_LINUX are defined. pddiwin32.hpp
// uses stdint types and works correctly on both platforms.
